...
const earliestRanked = Planner.selectRecommendedJourneys([earlierArrival, shorterButLater], [], { limit: 3 });
assert.equal(earliestRanked[0].signature, 'earlier-longer');
assert.equal(earliestRanked[0].arrivalSec, 33 * 60);
